...
const MODAL_SPRITE_LIBRARY2 = 'spriteLibrary2';
...
const openSoundLibraryBySideMenu= function () {
    return openModal(MODAL_SOUND_LIBRARY);
};
const openSpriteLibrary = function () {
    return openModal(MODAL_SPRITE_LIBRARY);
};
const openSpriteLibrary2 = function () {
    return openModal(MODAL_SPRITE_LIBRARY2);
};
...
const closeSpriteLibrary2 = function () {
    return closeModal(MODAL_SPRITE_LIBRARY2);
};
